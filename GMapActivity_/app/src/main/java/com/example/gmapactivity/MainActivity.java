...
public class MainActivity extends AppCompatActivity implements OnMapReadyCallback {
    ...
    FusedLocationProviderClient fusedLocationProviderClient;
    private SearchView mapSearchView;
    private List<LatLng> userPath = new ArrayList<>(); // Lista para armazenar a trajetória
    private Polygon userPathPolygon; // Para desenhar o polígono da trajetória
    ...
    // Inicia a atualização contínua da localização
        ...
        LocationCallback locationCallback = new LocationCallback() {
            ...
            public void onLocationResult(com.google.android.gms.location.LocationResult locationResult) {
                if (locationResult != null && locationResult.getLastLocation() != null) {
                    ...
                    userPath.add(userLatLng);

                    // Atualiza o polígono
                    if (userPathPolygon != null) {
                        userPathPolygon.remove();
                    }
                    userPathPolygon = gMap.addPolygon(new PolygonOptions().addAll(userPath).clickable(true));
                }
            }
        };
